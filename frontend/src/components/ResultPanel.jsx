 ...
 *
 * Save responses may also carry missing_required_fields /
 * unmatched_apm_fields / unmatched_frontend_fields (see SaveRowResponse
 * in backend/models.py) -- those are surfaced in the backend logs
 * (tools/row_mapper.py) rather than in this UI, so a successful save
 * always just shows a plain green tick.
 */
